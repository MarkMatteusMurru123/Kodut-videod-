...
namespace Abc.Tests
{
    internal class HtmlHelperMock<TModel> : IHtmlHelper<TModel>
    {
        ...
        public IHtmlContent LabelFor<TResult>(Expression<Func<TModel, TResult>> e, string labelText, object htmlAttributes)=> new HtmlContentMock($"LabelFor{GetMember.Name(e)}");
        ...
        public IHtmlContent TextBoxFor<TResult>
            (Expression<Func<TModel, TResult>> expression, string format, object htmlAttributes)
            => new HtmlContentMock("TextBoxFor");


        public IHtmlContent ValidationMessageFor<TResult>(Expression<Func<TModel, TResult>> expression, string message, object htmlAttributes, string tag)=> new HtmlContentMock("ValidationMessageFor");
        

        public string ValueFor<TResult>
            (Expression<Func<TModel, TResult>> e, string format)
            => "ValueFor";
